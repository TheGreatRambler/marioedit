...
namespace MM2 {
	...
	public:
		...
		enum autoscroll_speed_t {
			AUTOSCROLL_SPEED_X1 = 0,
			AUTOSCROLL_SPEED_X2 = 1,
			AUTOSCROLL_SPEED_X3 = 2
		};
		...
		enum clear_condition_t {
			...
			CLEAR_CONDITION_REACH_THE_GOAL_AFTER_DEFEATING_AT_LEAST_ALL_GOOMBA_GALOOMBA
			= 2131209407,
			...
			CLEAR_CONDITION_REACH_THE_GOAL_AFTER_DEFEATING_AT_LEAST_ALL_GOOMBRAT_GOOMBUD
			= 3346433512,
			...
			CLEAR_CONDITION_REACH_THE_GOAL_AFTER_DEFEATING_AT_LEAST_ALL_STINGBY_STINGBIES
			= 3824561269,
			CLEAR_CONDITION_REACH_THE_GOAL_AFTER_DEFEATING_AT_LEAST_ALL_PIRANHA_CREEPER
			= 3833342952,
			CLEAR_CONDITION_REACH_THE_GOAL_AFTER_DEFEATING_AT_LEAST_ALL_FIRE_PIRANHA_PLANT
			= 3842179831,
		...
		level_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = nullptr,
			level_t* p__root = nullptr);
	...
	public:
		...
		public:
			enum boundary_type_t {
				BOUNDARY_TYPE_BUILT_ABOVE_LINE = 0,
				BOUNDARY_TYPE_BUILT_BELOW_LINE = 1
			};
		...
		public:
			clear_pipe_node_t(kaitai::kstream* p__io, level_t::clear_pipe_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			track_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			track_block_node_t(kaitai::kstream* p__io, level_t::track_block_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			...
			obj_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			icicle_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			snake_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			clear_pipe_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			exclamation_block_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			ground_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			snake_node_t(kaitai::kstream* p__io, level_t::snake_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			sound_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			track_block_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			piranha_creeper_node_t(kaitai::kstream* p__io,
				level_t::piranha_creeper_t* p__parent = nullptr, level_t* p__root = nullptr);
		...
		public:
			piranha_creeper_t(kaitai::kstream* p__io, level_t::map_t* p__parent = nullptr,
				level_t* p__root = nullptr);
		...
		public:
			exclamation_block_node_t(kaitai::kstream* p__io,
				level_t::exclamation_block_t* p__parent = nullptr, level_t* p__root = nullptr);
